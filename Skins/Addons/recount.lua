...
function RecountAOS:ApplySettings()
	if not E.private.addOnSkins.Recount then return end
	local backdropAlpha = E.db.addOnSkins.recountBackdropAlpha
	Recount.MainWindow.backdrop:SetAlpha(backdropAlpha)
end
